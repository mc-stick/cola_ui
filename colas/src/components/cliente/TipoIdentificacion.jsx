        ...
        <div id="titulo-paso" className="animation-fade-in text-center">
          ...
          <div
            ...
            <button
              ...
              <div className="bg-[--color-primary-green] w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform">
            ...
            <button
              ...
              <div className="bg-[--color-primary-blue] w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform">
            ...
            <button
              ...
              <div className="bg-[--color-mono-gold] w-20 h-20 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform">
