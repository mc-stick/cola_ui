      ...
      <div className=" flex-1 min-h-0 flex flex-col justify-center ">
        ...
        <div className=" w-full max-w-6xl mx-auto flex flex-col h-full ">
          ...
          <div className=" text-center mb-4 sm:mb-5 md:mb-6 flex-shrink-0 ">
            {" "}
            <h2 className=" text-2xl sm:text-3xl md:text-4xl font-black text-slate-800 mb-2 leading-tight ">
              {" "}
          ...
          <div
            id="titulo-paso"
            className=" grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 flex-1 min-h-0 "
          >
            {" "}
            {opciones.map((s, ind) => (
              <button
...
"
              >
                ...
                {/* EFECTO */}{" "}
                <div
                  className={` absolute -top-5 -right-5 w-24 h-24 rounded-full opacity-5 group-hover:scale-150 transition-transform duration-500 ${s.color} `}
                />{" "}
                {/* ICON */}{" "}
                <div
                  className={` ${s.color} w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center mb-4 shadow-lg group-hover:rotate-6 transition-transform `}
                >
                  {" "}
                  {s.icon}{" "}
                </div>{" "}
                ...
                {/* CTA */}{" "}
                <div className=" absolute bottom-5 flex items-center gap-2 text-blue-600 font-bold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity ">
                  {" "}
          ...
          {/* ───────────────────────── */} {/* FOOTER */}{" "}
          {/* ───────────────────────── */}{" "}
          <div className=" flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 md:pt-5 mt-4 border-t border-slate-100 flex-shrink-0 ">
            {" "}
            <button
              id="btn-tk"
              onClick={() => setIsModalTKOpen(true)}
              className=" group flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-slate-100 hover:bg-amber-100 text-slate-600 hover:text-amber-700 transition-all font-bold text-xs sm:text-sm uppercase tracking-wide w-full sm:w-auto "
            >
              {" "}
            ...
            <button
              ...
              className=" flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-white border border-slate-200 hover:border-blue-300 text-slate-500 hover:text-blue-600 transition-all font-bold text-xs sm:text-sm uppercase tracking-wide w-full sm:w-auto "
            >
              {" "}
              <HelpCircleIcon className="w-5 h-5" /> Centro de Ayuda{" "}
            </button>{" "}
          </div>{" "}
        </div>{" "}
      </div>{" "}
