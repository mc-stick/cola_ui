      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 relative">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {seccion === "4" && <UsuariosSection usuarios={usuarios} puestos={puestos} LoadingSpin={LoadingSpin} onGuardarUsuario={async (f, e) => { if (e === "nuevo") await API.createUsuario(f); else await API.updateUsuario(e, f); cargarDatos(); }} onSwitchUser={async (id) => { await API.switchUser(id); cargarDatos(); }} onSyncLdap={async (id) => { await API.SyncLdap(); cargarDatos(); }} onDeleteUser={async (id) => { if (window.confirm("¿Eliminar?")) { await API.deleteUser(id); cargarDatos(); } }} validarUsuario={validarUsuario} />}
